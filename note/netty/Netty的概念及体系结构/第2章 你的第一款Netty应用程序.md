...
<img src="../../../picture/netty/Netty的概念及体系结构/image-20220530225136805.png" alt="image-20220530225136805" style="zoom:80%;" />
...
```tex
	   NioEventLoop            InboundHandler 实例链
			↓			 | <———————————————————————— |
	 NioSocketChannel ———— |          pipeline         | —————— localSocket —————— remoteSocket
						 | ————————————————————————> |
						     OutboundHandler 实例链
```
